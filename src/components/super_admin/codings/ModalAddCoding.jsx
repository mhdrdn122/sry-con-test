...
import { useAddNewCodingMutation, useUpdateCodingMutation } from '../../../redux/slice/super_admin/codings/codingsApi';

const ModalAddCoding = ({ show, handleClose }) => {
    ...
    onSubmit: async (values) => {
        ...
        const result = await addNewCoding(values).unwrap();
        console.log(result);
    },   
  ...
  return (
      ...
      <Modal.Header className="d-flex justify-content-center">
          <Modal.Title>إضافة نموذج</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Box
            m="40px 0 0 0"
